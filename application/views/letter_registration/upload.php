    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default">
          <div class="panel-heading"><svg class="glyph stroked email"></svg> Lettrer Registrations</div>
...
<div class="form-group">
      ...
      <input class="datepicker form-control"  id="issue_dt" name="issue_dt" value="<?php echo set_value('issue_dt'); ?>" required>
...
<input type="text" spellcheck="true" class="form-control" onblur="upper_str(this)" id="add_authority_name" name="add_authority_name" value="<?php echo set_value('add_authority_name'); ?>" required>
 ...
 <!--  coding for ADD FILE CREATED Field -->
 ...
 <div class="form-group">
                    ...
                    <div class="col-md-4 has-success">
                    <select class="form-control designation" id="designation" name="designation" required>
                      <option value="">---Select one---</option>
